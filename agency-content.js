...
function ContactsFunc() {
  ...
  if (x === undefined || x === null) {
    ...
    setTimeout(() => {
      ...
      document.querySelector("#smartlists > div.hl_controls.hl_smartlists--controls > div.hl_controls--left > span.bulk-actions-list > span:nth-child(11)").remove();
  }, 2000);
