...
// outside of the anonymous function, we keep AddForm and closeForm so that the HTML elements can access them

let addFormFunc = function addForm() {
...
let closeFormFunc = function closeForm() {
  let body = document.querySelector("body");
