...
try {
  ...
  function addUploadWindow(event) {
    ...
    cfInner.innerHTML =
      ...
      `/medias" loading="lazy" style="position: absolute; top: 0px; left: 0; width: 100%; height: 75vh; border: none;"></iframe></div><!----></div><span tabindex="0"></span></div></div><div id="__BVID__310___BV_modal_backdrop_" class="modal-backdrop"></div></div></customform>`;
  }
